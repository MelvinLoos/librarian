<template>
  <div class="min-h-screen bg-surface text-on-surface">
    <header class="fixed inset-x-0 top-0 z-50 border-b border-outline-variant/10 bg-surface/95 backdrop-blur-xl">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3">
        <div class="flex items-center gap-3 sm:gap-6">
          ...
          <div class="flex-1 relative group">
            <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant/50 text-lg transition-colors group-focus-within:text-primary">search</span>
            <input
    ...
    <nav class="fixed inset-x-0 bottom-0 z-50 border-t border-outline-variant/10 bg-surface/95 backdrop-blur-md pb-6 pt-2">
      <div class="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6">
        <NuxtLink to="/" class="flex flex-col items-center justify-center gap-1 text-xs text-on-surface-variant transition hover:text-primary">
        ...
        <NuxtLink to="/downloads" class="flex flex-col items-center justify-center gap-1 text-xs text-on-surface-variant transition hover:text-primary">
          <span class="material-symbols-outlined text-2xl">download_for_offline</span>
          <span>Downloads</span>
        </NuxtLink>

        <NuxtLink to="/settings" class="flex flex-col items-center justify-center gap-1 text-xs text-on-surface-variant transition hover:text-primary">
        ...
        <button
          ...
          class="flex flex-col items-center justify-center gap-1 text-xs text-on-surface-variant transition hover:text-error"
        >
          <span class="material-symbols-outlined text-2xl">logout</span>
          <span>Logout</span>
        </button>
        <NuxtLink v-else to="/login" class="flex flex-col items-center justify-center gap-1 text-xs text-on-surface-variant transition hover:text-primary">
