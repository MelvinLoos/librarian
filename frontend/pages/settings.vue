        ...
        <div class="grid gap-6 md:grid-cols-2">
          <div class="rounded-[2rem] bg-gray-900/55 p-6">
            ...
            <div class="mt-4 space-y-3 text-sm text-gray-300">
              <div>
                ...
                <p class="mt-2 text-base text-gray-100">{{ authStore.user.email || 'Not signed in' }}</p>
              </div>
              <div>
                <p class="text-xs uppercase tracking-[0.3em] text-gray-500">Role</p>
                <p class="mt-2 text-base text-violet-300">{{ authStore.user.role }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="rounded-[2rem] bg-gray-900/55 p-6">
            ...
            <div class="mt-6 rounded-[2rem] bg-gray-950/70 p-4 text-sm text-gray-300">
              <p class="break-all">https://your.librarian.instance/opds/{{ authStore.user.id || 'local' }}</p>
            </div>
          </div>
        </div>
      </div>
